 ...
 */
export function newWorkerMatchEmailHtml({ targetJob, sector, region, experience, offerTitle }) {
  const body = `
 ...
 */
export function newOfferMatchEmailHtml({ jobTitle, companyName, sector, region, contractType, urgency }) {

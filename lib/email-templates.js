    ...
    <tr>
      <td align="center">
        <table width="620" cellpadding="0" cellspacing="0" style="max-width:620px;width:100%;background:#ffffff;border-radius:24px;overflow:hidden;box-shadow:0 8px 40px rgba(30,58,120,0.12);">
          ...
          <!-- HEADER -->
          <tr>
            <td style="background:linear-gradient(150deg,#1a3470 0%,#1E3A78 50%,#1a4a8a 100%);padding:36px 48px 32px;">
              <table width="100%" cellpadding="0" cellspacing="0">
                <tr>
                  ...
                  <td align="right" style="vertical-align:bottom;">
                    <span style="font-size:11px;color:rgba(255,255,255,0.45);letter-spacing:0.5px;">lexpat-connect.be</span>
                  </td>
                </tr>
              </table>
            </td>

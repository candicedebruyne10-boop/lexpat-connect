            ...
            <td style="background:#f8fafb;border-top:1px solid #e4edf4;padding:20px 40px;">
              <table width="100%" cellpadding="0" cellspacing="0" style="margin:0 0 16px;">
                <tr>
                  ...
                  <td style="vertical-align:middle;">
                    <p style="margin:0 0 2px;font-family:'Montserrat',Arial,Helvetica,sans-serif;font-size:14px;font-weight:800;color:#1E3A78;">
                      ${isEn ? "The LEXPAT Connect team" : "LՎquipe LEXPAT Connect"}
                    </p>
                    <p style="margin:0;font-size:11px;color:#7d90a8;line-height:1.5;">

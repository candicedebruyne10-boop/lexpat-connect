...
const _rawVersion = (process.env.LINKEDIN_API_VERSION || "").replace(/[^0-9]/g, "");
// Accepte YYYYMMDD (tronque à YYYYMM) ou YYYYMM. Tout autre format → fallback.
export const LINKEDIN_API_VERSION =
  _rawVersion.length === 8 ? _rawVersion.slice(0, 6)
  : _rawVersion.length === 6 ? _rawVersion
  : "202506";

...
export default function SiteChrome({ children }) {
  ...
  const navDropdowns = {
    "/employeurs": {
      ...
      items: [
        {
          href: isEn ? "/en/employeurs/espace" : "/employeurs/espace",
        ...
        {
          href: isEn ? "/en/employeurs" : "/employeurs",
        ...
        {
          href: isEn ? "/en/recrutement-international" : "/recrutement-international",
          label: isEn ? "International recruitment" : "Recrutement international",
          description: isEn ? "6 in 10 Belgian companies already do it" : "6 entreprises sur 10 le font déjà",
          icon: "globe",
        },
        {
          href: isEn ? "/en/employeurs/liege-metiers-en-penurie" : "/employeurs/liege-metiers-en-penurie",
          label: "Liège",
          description: isEn ? "Shortage occupations in Liège" : "Métiers en pénurie à Liège",
          icon: "pin",
        },
        {
          href: isEn ? "/en/employeurs/anvers-metiers-en-penurie" : "/employeurs/anvers-metiers-en-penurie",
          label: isEn ? "Antwerp" : "Anvers",
          description: isEn ? "Shortage occupations in Antwerp" : "Métiers en pénurie à Anvers",
          icon: "pin",
        },
        {
          href: isEn ? "/en/employeurs/gand-metiers-en-penurie" : "/employeurs/gand-metiers-en-penurie",
          label: isEn ? "Ghent" : "Gand",
          description: isEn ? "Shortage occupations in Ghent" : "Métiers en pénurie à Gand",
          icon: "pin",
        },
        {
          href: isEn ? "/en/employeurs/bruges-metiers-en-penurie" : "/employeurs/bruges-metiers-en-penurie",
          label: "Bruges",

...
import { FlandreLists, GroupGrid } from "../../components/ShortageGroups";
          ...
          {shortageJobs2026.map((region) => {
            ...
            return (
              ...
              >
                ...
                {region.id === "flandre" ? (
                  <FlandreLists region={region} style={style} lang="fr" />
                ) : (
                  <div className="mt-6">
                    <GroupGrid groups={region.groups} style={style} lang="fr" />
                  </div>
                )}
              </article>
            );
